-- Run this in Supabase Dashboard → SQL Editor if you already have the base tables
-- (schools, transactions, uacs_codes) and only need the latest security + stats update.
