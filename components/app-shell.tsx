      ...
      <main className="ml-[260px]">
        <header className="sticky top-0 z-30 flex h-[72px] items-center justify-between border-b border-border bg-white px-6">
          <div className="relative w-full max-w-[520px]">
            ...
            <input
              className="h-9 w-full rounded border border-input bg-muted pl-10 pr-3 text-sm outline-none placeholder:text-muted-foreground focus:border-primary focus:bg-white focus:ring-2 focus:ring-primary/20"
          ...
          <div className="flex items-center gap-5 text-sm">
            ...
            <button className="text-foreground hover:text-primary" aria-label="Notifications">
              <Bell className="h-4 w-4" />
            </button>
            <button className="text-foreground hover:text-primary" aria-label="Help">
